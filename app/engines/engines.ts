...
export const ENGINES: Engine[] = [
  ...
  },
  {
    ...
    name: "Build Engine",
    emoji: "🛠️",
    tagline: "Turn the idea into a version you can actually make.",
  ...
  },
  {
    ...
    name: "Sell Engine",
    emoji: "💰",
    tagline: "Turn what you have into something someone can understand and buy.",
  ...
  },
  {
    ...
    name: "Launch Engine",
    emoji: "🚀",
    tagline: "Get the finished thing in front of real people.",
  ...
  },
  {
    ...
    name: "Fix Engine",
    emoji: "🔧",
    tagline: "Figure out what is actually wrong and make the smallest safe fix.",
  ...
  },
  {
    ...
    name: "Grow Engine",
    emoji: "📈",
    tagline: "Find the next useful growth move.",
  ...
  },
  {
    ...
    name: "Plan Engine",
    emoji: "🗺️",
    tagline: "Decide what matters next.",

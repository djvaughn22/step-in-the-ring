...
export const ENGINE_REGISTRY: CreationEngineDescriptor[] = [
...

  {
    ...
    name: "Game Engine",
    emoji: "🎮",
    tagline: "Game idea → rules → prototype → printable assets",
    description: "Design games: mechanics, rules, components, cards/boards data, difficulty system, test scenarios.",
    category: "interactive",
    launched: false,

    suggestedStage: "Spark",
    supportedStages: ["Spark", "Building", "Testing"],

    intake: [],
    generatesDirections: true,
    directionsCount: 3,
    scoringDimensions: [],
    outputTypes: ["json", "design"],
    realOutputDescription: "Game mechanics, rules PDF, card/component data, printable prototype, difficulty system.",
    specialties: [],
    adapters: [],
    technical: false,
    requiresApproval: true,
